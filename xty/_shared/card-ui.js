...
if (typeof location !== 'undefined' && /^\/xty\/?$/.test(location.pathname)) {
  ...
  await import('./home-cover-v3.js?v=20260820-daily2').catch(error => console.warn('XTY home cover layer unavailable', error));
  await import('./home-daily-meta.js?v=20260820-2').catch(error => console.warn('XTY home daily metadata unavailable', error));
