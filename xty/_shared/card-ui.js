...
export function cardStatusLabel(status) {
  return ({ AVAILABLE: 'พร้อมใช้งาน', AVATAR_IN_USE: 'ใช้อยู่เป็น สัตว์', IN_PARTY: 'ใช้อยู่เป็น ปกสมุด', NPC_IN_PARTY: 'ใช้อยู่เป็น เพื่อนร่วมทาง' })[status] || 'เก็บในคอลเลกชัน';
}