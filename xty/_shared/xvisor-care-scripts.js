...
const SCRIPTS = Object.freeze({
  ...
  day21: Object.freeze({
    quiet: Object.freeze([
      'ช่วงท้ายนี้ยังไม่ต้องเพิ่ม ช่วง ใหม่ อะไรคือหนึ่งจุดที่ทำให้ Action เดิมกลับมาเกิดได้ง่ายขึ้น?',
    ]),
    moving: Object.freeze([
  ...
  day28: Object.freeze({
    quiet: Object.freeze([
      'รอบนี้อาจยังไม่มี Pattern ชัดพอ ถ้าตั้ง ช่วง ใหม่ อยากทำให้จุดเริ่มง่ายขึ้นตรงไหน?',
    ]),
    moving: Object.freeze([
      'จาก log รอบนี้ มีหนึ่ง Pattern ไหนที่อยากพาไป ช่วง ถัดไป?',
