...
- **Current offer, confirmed by the user on 2026-09-16: 50 free introductory credits exclusively for new signups through `https://studio.airova.ai/auth/join?via=MYCLOVER`.** This is 50 credits total, not 50 additional credits. The public/direct signup offer is not this partner offer. myClover Official Partner status is user provided.
...
- Facebook/Open Graph and Twitter use `assets/airova-share-exclusive-50-v10.png`, a 2400 × 1260 lossless PNG retaining the preferred original campaign and MCP badge. The offer reads “ฟรี 50 เครดิต” and the CTA identifies signup through myClover as exclusive.
