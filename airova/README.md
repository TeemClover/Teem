...
- Facebook/Open Graph and Twitter use `assets/airova-share-source-v8.png`, a 2400 × 1260 lossless PNG: the user’s original portrait, one source branching into four distinct video styles, and native Facebook/Instagram/TikTok icons. Oversized bold Thai copy and the italic lime 30-credit offer follow the user’s preferred reference.
