# Route Guard — /xircle/doc/routinex/
...
## Job
deep reference ของ ABCD และ 28-day rhythm

## Flow
- **Entry:** ข้อมูลเชิงลึก/Product/Academy
- **Exit:** ABCD, Day-28, X-VISOR, Habix

## สิ่งที่ผู้ใช้ต้องเข้าใจเมื่อออกจากหน้านี้
ทำดีให้เกิดซ้ำ; routine ไม่ใช่ชื่อสินค้า

## Locks — ห้ามทำหาย
older deep snapshotมี ABCD 4 letters; canonical user journey = ABCD + Flavor+, NO E
