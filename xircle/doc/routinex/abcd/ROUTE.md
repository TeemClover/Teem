# Route Guard — /xircle/doc/routinex/abcd/
...
## Job
แยก A/B/C/D และเน้น C=behavior

## Flow
- **Entry:** RoutineX/Habix
- **Exit:** Day-28, product deep docs

## สิ่งที่ผู้ใช้ต้องเข้าใจเมื่อออกจากหน้านี้
4 ขั้นไม่ใช่ 4 สินค้า; C ไม่มี product

## Locks — ห้ามทำหาย
current canonical = ABCD + Flavor+; ห้าม E; C UI ไม่ควรมีขวด
