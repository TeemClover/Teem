# Route Guard — /xircle/doc/routinex/day-28/
...
## Job
deep reference ของ fulfillment + coaching cadence

## Flow
- **Entry:** RoutineX/ABCD
- **Exit:** X-VISOR onboarding/coaching

## สิ่งที่ผู้ใช้ต้องเข้าใจเมื่อออกจากหน้านี้
Day 0/3/7/14/21/28 = touchpoints; Day28 reviewแล้วต่อ

## Locks — ห้ามทำหาย
ไม่ใช่ biological guarantee หรือคอร์สกินครบแล้วจบ
