# Route Guard — /xircle/doc/ecosystem/
...
## Job
อธิบาย Xircle/Habix/RoutineX/X-VISOR/XOS เป็นชิ้นคนละหน้าที่

## Flow
- **Entry:** ข้อมูลเชิงลึก
- **Exit:** App, RoutineX, X-VISOR, XOS

## สิ่งที่ผู้ใช้ต้องเข้าใจเมื่อออกจากหน้านี้
แต่ละชิ้นมีงานของตัวเองและต่อเป็น loop

## Locks — ห้ามทำหาย
deep source snapshot; owner instruction ล่าสุดชนะ naming/ownership
