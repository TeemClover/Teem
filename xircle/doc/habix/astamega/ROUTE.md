# Route Guard — /xircle/doc/habix/astamega/
...
## Job
product education ของ D · Daily Balance ฝั่ง Oil Phase

## Flow
- **Entry:** Habix/Products/RoutineX D
- **Exit:** Vita Matrix, RoutineX, Habix

## สิ่งที่ผู้ใช้ต้องเข้าใจเมื่อออกจากหน้านี้
อธิบาย ingredient selection และ dose boundary

## Locks — ห้ามทำหาย
K2 unit unresolved; ingredient research ≠ final-product claim
