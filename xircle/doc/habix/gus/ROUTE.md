# Route Guard — /xircle/doc/habix/gus/
...
## Job
product education ของ A · Absorb / fiber+gut support

## Flow
- **Entry:** Habix/Products/RoutineX A
- **Exit:** Protein HMB+, RoutineX, Habix

## สิ่งที่ผู้ใช้ต้องเข้าใจเมื่อออกจากหน้านี้
ช่วยเสริมใยอาหาร/สมดุลลำไส้ในกรอบ supplement

## Locks — ห้ามทำหาย
CFU unresolved; ห้าม IBS/leaky gut/detox claims; ingredient study ≠ product result
