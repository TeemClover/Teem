...
## Job
อธิบาย nutrition/product layer หลัง behavior/nutrient need

## Flow
- **Entry:** products/ข้อมูลเชิงลึก
- **Exit:** product stories, FIVES, RoutineX

## สิ่งที่ผู้ใช้ต้องเข้าใจเมื่อออกจากหน้านี้
Habix = product brand; RoutineX = routine system

## Locks — ห้ามทำหาย
claim/registration/spec ต้อง source ล่าสุด; supplements ไม่แทน behavior
