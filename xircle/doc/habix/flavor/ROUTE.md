# Route Guard — /xircle/doc/habix/flavor/
...
## Job
อธิบาย Flavor+ เป็น consistency/adherence design

## Flow
- **Entry:** Habix/RoutineX
- **Exit:** ABCD/Habix

## สิ่งที่ผู้ใช้ต้องเข้าใจเมื่อออกจากหน้านี้
รสช่วยลด friction โดยไม่เปลี่ยน routine

## Locks — ห้ามทำหาย
ชื่อรส final ต้อง verify packaging; ไม่ยก flavor ingredient เป็น health hero
