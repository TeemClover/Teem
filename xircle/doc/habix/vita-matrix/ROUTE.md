# Route Guard — /xircle/doc/habix/vita-matrix/
...
## Job
product education ของ D · Daily Balance ฝั่ง Water Phase

## Flow
- **Entry:** Habix/Products/RoutineX D
- **Exit:** AstaMega+, RoutineX, Habix

## สิ่งที่ผู้ใช้ต้องเข้าใจเมื่อออกจากหน้านี้
Water + Oil = Daily Balance support

## Locks — ห้ามทำหาย
MetaZome dose/registration/vegan/halal/allergen verify; ห้ามแปลง compound→elemental เอง
