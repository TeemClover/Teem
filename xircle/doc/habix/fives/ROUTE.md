# Route Guard — /xircle/doc/habix/fives/
...
## Job
อธิบาย Functional/Intelligent/Value/Effective/Science

## Flow
- **Entry:** Habix
- **Exit:** product stories/Habix

## สิ่งที่ผู้ใช้ต้องเข้าใจเมื่อออกจากหน้านี้
ตอบว่าทำไม ingredient อยู่ในสูตร

## Locks — ห้ามทำหาย
FIVES ไม่ใช่ efficacy guarantee; science อยู่ใน claim boundary
