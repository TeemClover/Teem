# Route Guard — /xircle/doc/commerce/glossary/
...
## Job
ล็อกความหมายคำ business ก่อนคุยตัวเลข

## Flow
- **Entry:** X-Commerce/Revenue
- **Exit:** Revenue, Roles, X-Commerce

## สิ่งที่ผู้ใช้ต้องเข้าใจเมื่อออกจากหน้านี้
หนึ่งคำหนึ่งความหมายลด calculation drift

## Locks — ห้ามทำหาย
qualification/rate/version ต้องอ้าง official plan
