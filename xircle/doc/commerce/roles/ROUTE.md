# Route Guard — /xircle/doc/commerce/roles/
...
## Job
แยก X-VISOR/X-LEAD/X-GEN ตามความรับผิดชอบก่อนรายได้

## Flow
- **Entry:** X-Commerce
- **Exit:** Revenue, Glossary, X-Commerce

## สิ่งที่ผู้ใช้ต้องเข้าใจเมื่อออกจากหน้านี้
Role before Revenue

## Locks — ห้ามทำหาย
X-GEN qualification/threshold ต้อง official latest source
