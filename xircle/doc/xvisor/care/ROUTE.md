# Route Guard — /xircle/doc/xvisor/care/
...
## Job
Change→Attract→Result→Elevate แบบลึก

## Flow
- **Entry:** X-VISOR/Academy
- **Exit:** Onboarding, Coaching, X-VISOR

## สิ่งที่ผู้ใช้ต้องเข้าใจเมื่อออกจากหน้านี้
CARE เริ่มจากใช้จริง/ฟังจริง ไม่ใช่ hard sell

## Locks — ห้ามทำหาย
proof ต้อง consent; recommendation ต้องย้อนกลับ data/context
