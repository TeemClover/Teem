# Route Guard — /xircle/doc/xvisor/claims/
...
## Job
internal guard พูดได้/ห้ามพูด; ingredient≠product claim

## Flow
- **Entry:** X-VISOR/Product routes
- **Exit:** Privacy, Coaching, X-VISOR

## สิ่งที่ผู้ใช้ต้องเข้าใจเมื่อออกจากหน้านี้
เรื่องจริงไม่ต้องพูดเกิน

## Locks — ห้ามทำหาย
internal guide ≠ legal approval; latest approved claim source ชนะ
