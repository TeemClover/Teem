# Route Guard — /xircle/doc/xvisor/coaching/
...
## Job
Health+Habit coaching, plateau, lifestyle, monthly review

## Flow
- **Entry:** Onboarding/CARE
- **Exit:** Claims, Privacy, Onboarding

## สิ่งที่ผู้ใช้ต้องเข้าใจเมื่อออกจากหน้านี้
Ask before tell; praise behavior; change one thing; customer chooses

## Locks — ห้ามทำหาย
ไม่วินิจฉัย; trendหลายจุดก่อนสรุป plateau; refer เมื่อเกิน scope
