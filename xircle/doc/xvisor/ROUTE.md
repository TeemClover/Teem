...
## Job
อธิบาย role, CARE, deep practice, boundaries

## Flow
- **Entry:** simulator/ข้อมูลเชิงลึก/Ecosystem
- **Exit:** CARE, Onboarding, Coaching, Claims, Privacy, XOS

## สิ่งที่ผู้ใช้ต้องเข้าใจเมื่อออกจากหน้านี้
ข้อมูลต้องมีคนช่วยแปลเป็น next action โดยไม่ข้ามขอบเขต

## Locks — ห้ามทำหาย
certification/role versioned; no diagnosis/medication/guarantee
