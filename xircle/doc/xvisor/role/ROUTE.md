# Route Guard — /xircle/doc/xvisor/role/
...
## Job
ล็อก role/scope/certification gate และ growth responsibility

## Flow
- **Entry:** X-VISOR/Academy
- **Exit:** CARE, Onboarding, Coaching

## สิ่งที่ผู้ใช้ต้องเข้าใจเมื่อออกจากหน้านี้
ช่วยข้อมูลกลายเป็นการลงมือ; ไม่ใช่แพทย์

## Locks — ห้ามทำหาย
role path ≠ income path; qualificationsต้อง current official source
