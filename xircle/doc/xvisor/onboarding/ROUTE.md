# Route Guard — /xircle/doc/xvisor/onboarding/
...
## Job
Discovery 8 → Day0 setup → first-week care
...
เริ่มให้ถูกก่อนเริ่มให้เร็ว; health limits ก่อน recommendation

## Locks — ห้ามทำหาย
App/Band/Scale setup เป็น App runtime ไม่สร้างซ้ำเว็บ; no outcome guarantee
