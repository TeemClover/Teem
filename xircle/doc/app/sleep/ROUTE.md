# Route Guard — /xircle/doc/app/sleep/
...
## Job
อธิบาย Duration/Deep/REM/Consistency/HRV/RHR เป็น trend

## Flow
- **Entry:** App/Habit Score/Move
- **Exit:** Habit Score, Body, Move

## สิ่งที่ผู้ใช้ต้องเข้าใจเมื่อออกจากหน้านี้
baseline ตัวเองและหลายคืนสำคัญกว่าค่าเดียว

## Locks — ห้ามทำหาย
ไม่วินิจฉัยจาก HRV/RHR/คืนเดียว; GH Window ไม่ใช่นาฬิกาฮอร์โมนตายตัว
