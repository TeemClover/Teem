# Route Guard — /xircle/doc/app/body/
...
## Job
สอนอ่าน Weight + Pure Muscle + Body Fat/Fat Mass เป็น trend

## Flow
- **Entry:** App/Habit Score
- **Exit:** MaxAge, Habit Score, App

## สิ่งที่ผู้ใช้ต้องเข้าใจเมื่อออกจากหน้านี้
ตัวเลขเดียวเล่าไม่พอ; measurement conditions สำคัญ

## Locks — ห้ามทำหาย
BIA = estimate; ไม่วินิจฉัย; demo values ไม่ใช่ guarantee
