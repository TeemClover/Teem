# Route Guard — /xircle/doc/app/eat/
...
## Job
อธิบาย Eat layer: logging, protein, IF, metabolic-balance metaphor

## Flow
- **Entry:** App/Habit Score
- **Exit:** Move, Sleep, Habit Score

## สิ่งที่ผู้ใช้ต้องเข้าใจเมื่อออกจากหน้านี้
อาหารเป็นข้อมูลเพื่อปรับมื้อต่อไป ไม่ใช่คำตัดสิน

## Locks — ห้ามทำหาย
ค่าพลังงานเป็น estimate; ไม่สร้าง production formula เอง
