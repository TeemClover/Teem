# Route Guard — /xircle/doc/app/move/
...
## Job
อธิบาย Steps, Workout, HR Zone, Zone 2, Cardio Bank

## Flow
- **Entry:** App/Habit Score/Eat
- **Exit:** Sleep, Eat, Habit Score

## สิ่งที่ผู้ใช้ต้องเข้าใจเมื่อออกจากหน้านี้
ทุกการขยับนับรวมและสะสมได้

## Locks — ห้ามทำหาย
Zone 2 ไม่ใช่ guarantee fat loss; ไม่สร้าง scoring rules เอง
