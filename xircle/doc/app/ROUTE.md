...
## Job
อธิบาย architecture App จริงและแยก Behavior/Outcome/Long-term

## Flow
- **Entry:** ข้อมูลเชิงลึก/Ecosystem
- **Exit:** Habit Score, Body, Eat, Move, Sleep, Hardware, Community, MaxAge

## สิ่งที่ผู้ใช้ต้องเข้าใจเมื่อออกจากหน้านี้
App = production tracker/data tool; website routeไม่สร้าง runtime ซ้ำ

## Locks — ห้ามทำหาย
Habit Score = Eat+Move+Sleep; Body separate outcome
