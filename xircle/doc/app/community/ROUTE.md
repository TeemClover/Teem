# Route Guard — /xircle/doc/app/community/
...
## Job
อธิบาย social layer ที่ช่วย habit โดยไม่กดดัน

## Flow
- **Entry:** App
- **Exit:** X-VISOR, XOS, App

## สิ่งที่ผู้ใช้ต้องเข้าใจเมื่อออกจากหน้านี้
วงที่ดีช่วยทำต่อ ไม่ทำสุขภาพเป็นการแข่งขัน

## Locks — ห้ามทำหาย
privacy/consent มาก่อน engagement; no humiliation
