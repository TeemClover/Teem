# Route Guard — /xircle/doc/app/hardware/
...
## Job
อธิบาย hardware roles และ data flow เข้า App

## Flow
- **Entry:** App/hardware bridge
- **Exit:** Habit Score, Body, App

## สิ่งที่ผู้ใช้ต้องเข้าใจเมื่อออกจากหน้านี้
Band = behavior; Scale = outcome

## Locks — ห้ามทำหาย
ไม่สร้าง pairing/runtime ที่นี่; consumer metrics ไม่ใช่ diagnosis
