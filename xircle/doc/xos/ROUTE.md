...
## Job
operating system หลังบ้าน: signal→mission→human action→follow-up

## Flow
- **Entry:** Ecosystem/X-VISOR/deep
- **Exit:** Missions, Customers, Team, Learning, Wealth, Source

## สิ่งที่ผู้ใช้ต้องเข้าใจเมื่อออกจากหน้านี้
ระบบช่วยจำ/จัดลำดับ แต่คนยังดูแล

## Locks — ห้ามทำหาย
consent/least access; XOS ไม่วินิจฉัย; thresholds ต้อง source
