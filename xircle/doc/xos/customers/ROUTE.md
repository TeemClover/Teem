# Route Guard — /xircle/doc/xos/customers/
...
## Job
CRM/lifecycle/relationship context และ consent

## Flow
- **Entry:** XOS
- **Exit:** Missions, Learning, XOS

## สิ่งที่ผู้ใช้ต้องเข้าใจเมื่อออกจากหน้านี้
คนก่อนข้อมูล; summary เท่าที่จำเป็น

## Locks — ห้ามทำหาย
segmentation thresholds conceptual; assigned+consented access
