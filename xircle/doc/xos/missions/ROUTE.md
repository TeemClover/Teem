# Route Guard — /xircle/doc/xos/missions/
...
## Job
แปลง signal เป็นงานที่คนดูแลทำได้วันนี้

## Flow
- **Entry:** XOS/Customers
- **Exit:** Customers, Learning, XOS

## สิ่งที่ผู้ใช้ต้องเข้าใจเมื่อออกจากหน้านี้
Signal→Priority→Mission→Human Action→Follow-up

## Locks — ห้ามทำหาย
health signal ≠ diagnosis; permitted data only
