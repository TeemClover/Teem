# Route Guard — /xircle/doc/xos/wealth/
...
## Job
version-aware business dashboard concept

## Flow
- **Entry:** XOS/X-Commerce
- **Exit:** X-Commerce, Source, XOS

## สิ่งที่ผู้ใช้ต้องเข้าใจเมื่อออกจากหน้านี้
ตัวเลข business ต้องมี PLAN VERSION + LAST VERIFIED

## Locks — ห้ามทำหาย
internal only; no earnings projection; conflictsห้ามเข้ calculator
