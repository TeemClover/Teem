# Route Guard — /xircle/doc/xos/team/
...
## Job
พัฒนาความสามารถทีมและมาตรฐาน care มากกว่า headcount

## Flow
- **Entry:** XOS/Learning
- **Exit:** Learning, Missions, XOS

## สิ่งที่ผู้ใช้ต้องเข้าใจเมื่อออกจากหน้านี้
X-LEAD = coach the coach; team quality ไม่ใช่ยอดอย่างเดียว

## Locks — ห้ามทำหาย
mock metrics ไม่ใช่ production; X-GEN qualification verify
