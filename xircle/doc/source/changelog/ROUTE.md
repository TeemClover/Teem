# Route Guard — /xircle/doc/source/changelog/
...
## Job
บันทึก source change → impact → rebuild/review

## Flow
- **Entry:** Source Control
- **Exit:** Sources, Unresolved, Source

## สิ่งที่ผู้ใช้ต้องเข้าใจเมื่อออกจากหน้านี้
ทุก source change ต้องตามไปถึงหน้าที่ได้รับผล

## Locks — ห้ามทำหาย
timeline ไม่ใช่ canonical fact ถ้า source ล่าสุดเปลี่ยน
