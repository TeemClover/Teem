# Route Guard — /xircle/doc/source/unresolved/
...
## Job
รายการสิ่งที่ห้ามเดา/hard-code

## Flow
- **Entry:** Source Control และ deep route เมื่อข้อมูลขาด
- **Exit:** Changelog, Glossary, Source

## สิ่งที่ผู้ใช้ต้องเข้าใจเมื่อออกจากหน้านี้
ถ้ายังไม่รู้ ให้ระบุ NEED SOURCE

## Locks — ห้ามทำหาย
formula/rates/regulatory/privacy blockers = ห้าม invent
