# Route Guard — /xircle/doc/source/sources/
...
## Job
ระบุ S1–S5 และ precedence ตามประเภทข้อมูล

## Flow
- **Entry:** Source Control
- **Exit:** Unresolved, Changelog, Source

## สิ่งที่ผู้ใช้ต้องเข้าใจเมื่อออกจากหน้านี้
ถามว่าเรื่องอะไร ก่อนถามว่าไฟล์ไหนใหม่กว่า

## Locks — ห้ามทำหาย
official/latest owner instructionเหนือ draft; volatile facts ต้อง verify
