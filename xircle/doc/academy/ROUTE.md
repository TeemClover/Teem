# Route Guard — /xircle/doc/academy/
...
## Job
มาตรฐานพัฒนาคน Foundation → Tools → Practice → Certification

## Flow
- **Entry:** ข้อมูลเชิงลึก/CARE/XOS Learning
- **Exit:** Certification, X-VISOR, XOS Learning

## สิ่งที่ผู้ใช้ต้องเข้าใจเมื่อออกจากหน้านี้
Capability ก่อนดูแลลูกค้าจริง

## Locks — ห้ามทำหาย
เกณฑ์สอบ/มาตรฐานเป็น versioned source ต้องตรวจรุ่นล่าสุด
