# Route Guard — /xircle/doc/academy/certification/
...
## Job
blueprint มาตรฐาน/ข้อสอบก่อนรับบทบาท X-VISOR

## Flow
- **Entry:** Academy/Explore
- **Exit:** Academy, Claims, Source

## สิ่งที่ผู้ใช้ต้องเข้าใจเมื่อออกจากหน้านี้
สอบวัดระบบ+CARE+Ethics ไม่ใช่จำสินค้าอย่างเดียว

## Locks — ห้ามทำหาย
pass/domain weights เป็น snapshot; simulator ไม่เท่ากับสอบผ่าน
