...
ค้นหาความรู้สั้นตามเรื่องที่อยากรู้ ไม่ต้องอ่านตามลำดับ

- Entry: direct link, search, another reference or the current Xircle route; no completion flags required.
- Exit: บทความ `/xircle/learn/topic/`, ข้อมูลเชิงลึก `/xircle/doc/`, แหล่งความรู้ภายนอกที่กำหนดไว้.
- Reading this material is optional; it is not a stage required before Meet.

## Runtime and state

`data/library-founder-v1.js`, `data/library-simple-v1.js`, inline search/filter/render code, `reference.js`, existing typography/CSS
...
รักษาเนื้อหาสั้น การค้นหาและตัวกรอง; แยกความรู้สุขภาพออกจาก product claim
...
The prior HTML and guard were archived unchanged at `archive/xircle-retired-20260910/xircle/learn/` under the visualization archive documented in the global source.
