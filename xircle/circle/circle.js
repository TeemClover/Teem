(function(){
  ...
  var days=[
    {day:'0',title:'เลือก 1 อย่าง',body:'เริ่มจากสิ่งที่ทำได้จริงในชีวิตประจำวัน ให้ทุกคนในกลุ่มเข้าใจตรงกันก่อนว่าจะลองทำอะไรในรอบนี้',points:['เลือกให้เล็กพอที่จะเริ่มได้','ตกลงกันว่าอะไรนับว่า “ทำแล้ว”','ยังไม่ต้องทำให้สมบูรณ์แบบ']},
