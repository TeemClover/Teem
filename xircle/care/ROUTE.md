...
## Job
สะพานจากข้อมูลไปสู่คนและบริบท

## Flow
- **Entry:** /xircle/
- **Exit:** /xircle/opportunity/

## สิ่งที่ผู้ใช้ต้องเข้าใจเมื่อออกจากหน้านี้
ถาม → ฟังบริบท → เลือก 1 อย่าง → ติดตาม → รู้ขอบเขต

## Locks — ห้ามทำหาย
ห้ามวินิจฉัย; xircle-care-hero = 16:9; White Cat Care ไม่แทนคน

## Dependencies / จุดเชื่อม
state.js, v5 CSS, care assets
