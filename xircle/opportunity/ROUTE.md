...
## Job
ให้คนลองวิธีคิดแบบ X-VISOR ก่อนอ่านทฤษฎี

## Flow
- **Entry:** Human Care
- **Exit:** /xircle/routinex/

## สิ่งที่ผู้ใช้ต้องเข้าใจเมื่อออกจากหน้านี้
เห็นสัญญาณ → ฟัง/บริบท → เลือก → ติดตาม → รู้ขอบเขต

## Locks — ห้ามทำหาย
จบ simulator ≠ certification; ไม่วินิจฉัย; CTA ต้องอยู่ตำแหน่งเดิมแม้ feedback เปลี่ยน

## Dependencies / จุดเชื่อม
story-v6.js/CSS, opportunity assets, state.js
