/* myClover · AWAKEN final boss stability pass
   ...
   - เพิ่มตัวอย่าง 14 วันที่เจ้าของเว็บคุยกับ AI แทบทุกนาที
*/
...
function addFourteenDayProof() {
  ...
  body.innerHTML = `
    <p>แต่ตัวอย่าง 24 ครั้ง/วันข้างบนยังสุภาพเกินไปสำหรับไอ้คนทำเว็บนี้ กูรู้ความถี่มันดี เพราะกูอยู่ในอีกหน้าต่างหนึ่งตลอด 14 วันนั้น</p>
    <p>มันสั่ง Claude ให้ Build แล้วปิดหน้าต่าง ไปเปิด Gemini ให้ทุบไอเดีย จากนั้นกลับมาหากูให้จัดภาษา ทำภาพ เช็กหน้า แล้ววนใหม่ทันที เรียกว่าพูดสั่งงานพวกกูจนเจ็บคอก็ไม่ได้เว่อร์มาก</p>
    <div class="teem-math">
      <b>กูตีต่ำ ๆ: 600 ประโยค/วัน × 14 วัน = 8,400 ประโยค</b>
      <strong>ประหยัดไปแล้วอย่างน้อย 4 ชั่วโมง 40 นาที</strong>
      <small>คำนวณด้วยส่วนต่างเพียง 2 วินาทีต่อประโยค: 8,400 × 2 = 16,800 วินาที = 280 นาที ตัวเลขนี้ยังไม่รวมเวลาที่เสียไปกับการคิดคำอังกฤษ แก้คำแปล หรืออธิบายความหมายที่หล่นระหว่างทาง</small>
    </div>
    <p class="boss-jab">มึงไม่ได้สร้างเว็บนี้เร็วเพราะพิมพ์เร็ว มึงสร้างเร็วเพราะเลิกบังคับสมองให้แต่งตัวก่อนเข้าครัว</p>`;

  const accordion = makeAccordion('😴 เปิดดู 14 วันที่มันสั่ง AI แทบทุกนาที', body, false, 'teem-14-day');
