  ...
  if(!fast){
    ...
    fast.innerHTML=`
      ...
      <div class="life-fast__steps">
        <article class="life-fast__step"><span class="life-fast__num">1</span><div><h3>สกัดซอส .md จากแชทเดิม</h3><p>วาง Prompt นี้ในแชทที่รู้จักคุณอยู่แล้ว ระบบต้องสร้างไฟล์ทันทีโดยไม่ถามกลับ</p><div class="prompt" data-life-prompt="extract" data-prompt-collapse></div></div></article>
        <article class="life-fast__step"><span class="life-fast__num">2</span><div><h3>เปิดแชทใหม่ที่สร้างภาพได้</h3><p>แนบซอส .md ทุกครั้ง แล้วเลือกเส้นทางที่ตรงกับไฟล์ในมือ</p><div class="life-paths"><div class="life-path"><b>🎨 มีซอส .md อย่างเดียว</b><p>ได้ Illustration หรือตัวละครวาดที่เล่าเรื่องจากซอส โดยไม่อ้างว่าใบหน้าเหมือนตัวจริง</p></div><div class="life-path"><b>📷 มีซอส .md + รูปจริง</b><p>ได้ภาพที่รักษาใบหน้า ทรงผม และลักษณะสำคัญของคนในรูปให้ใกล้เคียงต้นฉบับ</p></div></div><div class="life-md-alert"><strong>ห้ามลืมแนบซอส</strong><span>แนบซอส .md ในแชทใหม่นี้ก่อนทำข้อ 3 ถ้าต้องการภาพเหมือน ให้แนบรูปจริงพร้อมกันด้วย ไม่อย่างนั้นระบบจะไม่มีข้อมูลชีวิตเจ้าของบัญชีสำหรับสร้างภาพ</span></div></div></article>
        <article class="life-fast__step"><span class="life-fast__num">3</span><div><h3>สร้างภาพด้วยคำสั่งสั้น ๆ</h3><p>รายละเอียด 9:16 เรื่องราว สไตล์ และข้อห้ามอยู่ในซอสครบแล้ว แนบไฟล์ให้ครบ วางคำสั่งนี้ แล้วรอรับภาพได้เลย</p><div class="prompt" data-life-prompt="poster" data-prompt-guard="off"></div></div></article>
      </div>
      ...
      <section class="life-taste"><h2><span class="life-section-num">4</span>ชิมภาพหลังสร้าง — อย่าเพิ่งดูแค่ว่าสวยไหม</h2><p>ภาพแรกคือกระจกที่สะท้อนว่าระบบเข้าใจซอสอย่างไร ใช้เวลา 1 นาทีตรวจ 3 เรื่อง แล้วเก็บข้อสังเกตไว้ปรับซอสในบทต่อไป</p><ol><li><b>ตรง:</b> ตัวตน เรื่องราว และอารมณ์หลักที่เห็นในภาพตรงกับคุณหรือไม่</li><li><b>ขาด:</b> สิ่งสำคัญอะไรในซอสที่ภาพไม่ได้เล่าออกมา</li><li><b>เกิน:</b> มีประวัติ ความสำเร็จ ฉาก หรือสัญลักษณ์ใดที่ระบบแต่งขึ้นเอง</li></ol></section>
