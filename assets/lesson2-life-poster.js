...
# ซอส (Source) สำหรับโปสเตอร์หนังชีวิต
> เอกสารนี้คือ “ซอส” ที่คำสั่งสั้น “สร้างภาพตามซอสนี้” อ้างถึง
  ...
  if(!fast){
    ...
    fast.innerHTML=`
      ...
      <div class="life-fast__steps">
        <article class="life-fast__step"><span class="life-fast__num">1</span><div><h3>สกัดซอส .md จากแชทเดิม</h3><p>วาง Prompt นี้ในแชทที่รู้จักคุณอยู่แล้ว ระบบต้องสร้างไฟล์ทันทีโดยไม่ถามกลับ</p><div class="life-md-alert"><strong>ห้ามเริ่มจากแชทว่าง</strong><span>ข้อ 1 ต้องทำในแชทเดิมที่รู้จักคุณอยู่แล้ว เพราะขั้นนี้กำลังสกัดข้อมูลชีวิตออกมาเป็นซอส .md</span></div><div class="prompt" data-life-prompt="extract" data-prompt-collapse></div></div></article>
...
function patchFaqAndQuest(){
  ...
  if(list) list.innerHTML='<li>สกัดซอสจากแชทเดิมเป็นไฟล์ .md</li><li>เปิดแชทใหม่ แนบซอส และแนบรูปจริงเพิ่มเฉพาะเมื่อต้องการความเหมือน จากนั้นสร้างภาพ 9:16</li><li>ติ๊ก checklist ให้ครบ และบอกว่าอะไรตรง ขาด หรือถูกแต่งเกินจากซอส</li>';
