...
var TERMS={
  ...
  META:{th:'เมตา · วิธีเล่นที่เหมาะกับ Patch นี้',
    short:'รูปแบบที่กำลังได้ผลในสภาพแวดล้อมปัจจุบัน ไม่ใช่กฎถาวร',
    mc:'อ่านว่าเครื่องมือ วิธีทำงาน และข้อจำกัดตอนนี้เป็นอย่างไร แล้วเลือก Build ที่เหมาะ', go:W+'#meta'},
