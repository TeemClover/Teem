...
const OUTPUT_CONTRACT = `ผลลัพธ์สุดท้ายที่ต้องส่ง:
- สร้างเป็นไฟล์ Markdown จริง นามสกุล .md เท่านั้น
- ตั้งชื่อไฟล์ตามชื่อโปรเจกต์ให้สื่อความหมาย และต้องลงท้ายด้วย .md
- แนบไฟล์ให้ฉันกด Download ได้ทันที
- ห้ามส่งฉบับสุดท้ายเป็นข้อความยาวในแชตแทนไฟล์
- ก่อนแนบไฟล์ ให้ตรวจว่าเนื้อหาครบตามหัวข้อ ไม่มีข้อมูลที่แต่งเพิ่ม และไม่มีรหัสผ่านหรือข้อมูลอ่อนไหว
- ถ้าระบบนี้สร้างไฟล์ดาวน์โหลดไม่ได้จริง ๆ เท่านั้น ให้ใส่ Markdown ทั้งหมดใน code block เดียว โดยไม่มีคำอธิบายนอก code block เพื่อให้ฉันนำไปบรรจุด้วยเครื่องบรรจุซอส`;
