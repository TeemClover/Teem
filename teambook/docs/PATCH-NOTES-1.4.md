...
อัปเดตความจุสมุด: 2026-09-12 — เพิ่มเพดานจาก 11 เป็น 30 คน โดยยังใช้ค่าเริ่มต้น 5 คนและนับเจ้าของสมุดด้วย
...
- เจ้าของสมุดกำหนดความจุของแต่ละเล่มได้ **1–30 คน** ค่าเริ่มต้นและค่าที่ TeamBook แนะนำคือ **5 คน**
...
**คนในสมุด = 1–30 คนต่อเล่ม · default 5**

เจ้าของเลือก `memberLimit` ตอนสร้างด้วย stepper `− 5 คน +` ช่วงค่าคือ 1–30 และ 5 เป็นคำแนะนำ ไม่ใช่ข้อจำกัดของระบบ
...
1. สมาชิกจริงทั้งหมด ตามจำนวนที่อยู่ในสมุดจริง สูงสุด 30 คน
...
- render slot ว่างให้ครบตามความจุของสมุด
- นับ PET เป็นสมาชิก
...
ค่าปัจจุบันคือ 1–30 คน และ solo book แสดงเป็น `1/memberLimit` โดยเจ้าของสมุดนับเป็นสมาชิกคนแรก
...
- สมุดใหม่เลือกได้ 1–30 คน default 5
- คนที่ 6–30 ต้องมองเห็นบน Board จริง
