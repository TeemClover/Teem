...
function activity(id, labelTh, character, hintTh, metadata, options = {}) {
  return Object.freeze({
    ...
    character,
    hintTh,
    art: options.art || `/assets/art/activities/activity-${id}.webp`,
...
const DEFINITIONS = Object.freeze([
  ...
  }, { color: 'blue', art: '/assets/art/activities/activity-board-game.webp' }),
...
export const TEAMBOOK_ACTIVITY_CATALOG = DEFINITIONS;
export const TEAMBOOK_ACTIVITIES = Object.freeze(DEFINITIONS.filter(item => item.selectable));
...
export const TEAMBOOK_ACTIVITY_METADATA = Object.freeze(DEFINITIONS.reduce((map, item) => {
...
export const TEAMBOOK_PRESETS = Object.freeze([
