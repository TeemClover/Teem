...
function coverMarkup(party) {
  ...
  if (party.coverType === 'card_back') {
    return '<div class="xty-home-cover"><div class="animal-card card-back"><span class="back-mark">TB</span><small>TEAMBOOK</small></div></div>';
  }
...
function slideMarkup(entry, total) {
  ...
  return `<article class="xty-party-slide${total === 1 ? ' single' : ''}" data-code="${esc(party.code)}"><div class="card main-party">`
    ...
    + `<a class="btn gold sm" href="/p/?c=${encodeURIComponent(party.code)}">${terminal ? 'ดูฉากจบ' : 'เข้าร่วมสมุด / ลงชื่อ'}</a>`
    + `</div></div></article>`;
}
...
style.textContent = `
  ...
  .xty-home-cover>.animal-card,.xty-home-cover.avatar-cover{width:100%!important;height:100%!important;aspect-ratio:var(--xty-card-aspect)!important}
  ...
  .xty-party-row-cover .xty-home-cover>.animal-card,.xty-party-row-cover .xty-home-cover.avatar-cover{width:100%!important;height:100%!important;min-width:0!important;aspect-ratio:var(--xty-card-aspect)!important;border-radius:9px!important}
  ...
  @media(max-width:380px){.party-group .xty-party-summary-row{grid-template-columns:96px minmax(0,1fr) 16px!important;gap:9px!important;padding:9px 11px!important}.xty-party-row-visual{width:96px;height:76px;grid-template-columns:54px 36px;gap:6px}.xty-party-row-cover,.xty-party-row-cover .xty-home-cover,.xty-party-row-cover .xty-home-cover>.animal-card,.xty-party-row-cover .xty-home-real-back,.xty-party-row-cover .xty-home-cover.avatar-cover{width:54px!important;min-width:54px!important;height:76px!important}.xty-party-row-pet,.xty-party-row-pet>img{width:36px;height:36px}.xty-party-row-pet.is-card .animal-card{height:36px!important}.xty-party-row-pet{font-size:27px}}
`;
