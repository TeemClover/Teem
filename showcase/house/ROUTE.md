...
Build only this directory with npm run build. Keep root site configuration untouched. Preserve the independent state domains: building view, floor/room, evidence lens, wall setting, photo gallery. Test build, geometry/state tests, asset audit and browser flows before release. See README.md and reports/QA.md. No downloadable files are exposed in this revision: plans, guides and ZIPs remain outside the application tree. User authorized publishing this revision to main on 2026-09-24 after the west upper wall alignment correction.
