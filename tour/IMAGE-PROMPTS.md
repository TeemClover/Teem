...
> **สถานะ 2026-09-26:** ได้ภาพครบทั้ง 6 รายการแล้ว (แพ็ก `myclover-tour-art-20260926`) ย่อให้พอดีกรอบ
> และบีบเป็น WebP ใน `tour/art/` รวมราว 700 KB และลงทะเบียนใน `tour/art/manifest.json` แล้ว
> ภาพทีมสร้างจากรูปจริงในโปรเจกต์ (img/teem-pro.jpg, img/teem-life.jpg) ตามที่ระบุในแพ็ก
