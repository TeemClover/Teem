...
export const STATUS = Object.freeze({
  registered: { label: 'ลงทะเบียนแล้ว', message: 'ดูบทตัวอย่างได้ เมื่อชำระและตรวจยอดเรียบร้อย บทเรียนทั้งหมดจะเปิดให้ในบัญชีนี้' },
  pending: { label: 'รอตรวจการชำระ', message: 'เราได้รับรายการสมัครแล้ว ระหว่างรอตรวจ ดูบทตัวอย่างก่อนได้' },
