...
var lessonItems=LEARN.map(function(slug,i){return item({id:'lesson-'+(i+1),kind:'FREE LESSON '+(i+1),name:LEARN_NAME[i],icon:['✨','🖼️','🎬','📚','🧠','🌐'][i],on:on('lesson-'+(i+1)),hint:'เรียนบทที่ '+(i+1)+' จนจบ',go:'../classroom/'+slug+'.html',image:'../img/lesson-'+(i+1)+'.jpg?v=20260812-original-jpeg'})});
...
item({id:'blacksmith',kind:'SIGIL',name:'ช่างตีเหล็ก',icon:'⚒️',on:on('blacksmith'),hint:'อ่าน Forge ครบ 7 ตอน',go:'../forge/',image:'/forge/img/07-p1.jpg?v=20260812-1400-blacksmith'}),
