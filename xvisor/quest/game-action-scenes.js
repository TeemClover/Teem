...
export const ACTION_SCENE_MAP = Object.freeze({
  ...
  MAKE_OFFER: scene('offer', 'ชวนเริ่มแผน'),
  ...
  OFFER_PROSPECT: scene('offer', 'คุยเรื่องเริ่มแผน'),
  ...
  FAST_TRACK_FULL_START: scene('onboarding', 'คุยเรื่องเริ่มครบชุด', 'full-start'),
  RUN_LIVE: primary('live', 'ไลฟ์พูดคุยจากเคสจริง'),
