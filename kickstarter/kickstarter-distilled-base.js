(function(){
  ...
  const COPY = {
    en: {
      ...
      '.origin-copy blockquote': 'Three colors created the rules.<br>Gray created the game.',
      '.origin-copy p:nth-of-type(3)': 'Three colors formed a complete cycle. Then we added Gray—with no meaning, no power and no random effect. It was simply an empty card you could choose to throw away. That one empty choice created timing, sacrifice, bluffing and doubt.',
      ...
      '.how-list li:nth-child(3) p': 'The three-color cycle decides instantly. Gray blocks.',
      ...
      '.open-copy > p:first-of-type': 'Write RED, BLUE, GREEN and GRAY on paper. CORE7 still works. The rules stay open and online play stays free.',
    ...
    th: {
      ...
      '.origin-copy blockquote': 'สามสีสร้างกติกา<br>สีเทาสร้างเกม',
      '.origin-copy p:nth-of-type(3)': 'สามสีสร้างวงจรที่สมบูรณ์ แล้วเราเพิ่มสีเทาเข้าไปโดยไม่ให้ความหมาย ไม่ให้พลัง และไม่เพิ่มผลสุ่ม มันเป็นเพียงการ์ดว่างที่เลือกทิ้งได้ แต่ทางเลือกว่างนั้นกลับสร้างจังหวะ การเสียสละ การลวง และความลังเล',
      ...
      '.how-list li:nth-child(3) p': 'วงจรสามสีตัดสินทันที สีเทาบล็อก',
      ...
      '.open-copy > p:first-of-type': 'เขียน แดง ฟ้า เขียว เทา ลงบนกระดาษ CORE7 ก็ยังเล่นได้ กติกายังคงเปิด และออนไลน์ยังคงฟรี',
