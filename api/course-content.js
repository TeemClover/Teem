...
export const COURSE_CONTENT_FILES = Object.freeze([
  ...
  'index.html', 'course.css', 'course.js', 'course-content.js', 'course-resources.js',
  'resources/workflow-template.md', 'resources/instructor-guide.md',
  'resources/website-source-notes.md', 'resources/clinic-training-brief.md', 'resources/slide-notes.md',
  'resources/office-workflow-brief.md', 'resources/office-kit-example.md', 'resources/office-file-guide.md',
  'resources/followup-worksheet.md', 'resources/answer-key.md',
  'resources/prompt-library.md', 'resources/create-markdown-guide.md',
  'resources/review-checklist.md', 'resources/clinic-public-source.md', 'resources/source-example.md',
  'resources/excel-csv-guide.md', 'resources/tool-quickstart.md',
  'resources/ai-leader-homework.md',
