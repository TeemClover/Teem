...
- `learning.e2e.mjs`: all six lesson starts, step navigation, reload/resume, explicit artifact confirmation, progress across lessons, and compact/mobile/desktop layout. Original artwork stays available in the expandable introduction.
...
- `lesson34.e2e.mjs`: video readiness/playback, no video download before interaction, repair prompts and saved checks; lesson 4 output planning and the mismatch exercise.
