...
function addStyles() {
  ...
  style.textContent = `
    ...
    .c7-reward__flavor{margin:0;display:inline-block;width:100%;padding:14px 15px 13px;border:1px solid rgb(234 208 140/.25);border-radius:15px;color:rgb(255 255 255/.84);background:rgb(255 255 255/.055);font:500 14px/1.75 system-ui;animation:c7RewardStory .45s .08s ease both}
    .c7-reward__quote{display:inline-block;color:#ead08c;font:800 36px/.72 "Bai Jamjuree",system-ui;text-shadow:0 0 18px rgb(234 208 140/.2);vertical-align:-.16em;user-select:none}
    .c7-reward__quote--open{margin-right:6px}.c7-reward__quote--close{margin-left:4px}.c7-reward__flavor-text{display:inline}
