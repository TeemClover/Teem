...
function addStyles() {
  ...
  style.textContent = `
    ...
    .c7-reward__flavor{margin:0;display:grid;grid-template-columns:auto minmax(0,1fr) auto;gap:7px;align-items:start;padding:14px 15px 13px;border:1px solid rgb(234 208 140/.25);border-radius:15px;color:rgb(255 255 255/.84);background:rgb(255 255 255/.055);font:500 14px/1.75 system-ui;animation:c7RewardStory .45s .08s ease both}
    .c7-reward__quote{color:#ead08c;font:800 36px/.78 "Bai Jamjuree",system-ui;text-shadow:0 0 18px rgb(234 208 140/.2);user-select:none}
    .c7-reward__quote--open{align-self:start}.c7-reward__quote--close{align-self:end}.c7-reward__flavor-text{min-width:0;padding-top:2px}
  ...
  overlay.innerHTML = `
    <section class="c7-reward__panel">
      ...
      <div class="c7-reward__copy" aria-live="polite">
        <span class="c7-reward__eyebrow">MATCH COMPLETED · NEW CARD</span>
