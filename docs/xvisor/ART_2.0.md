...
used by both scene and portrait renderers, with immediate code-drawn fallbacks.
...
- `xvisor/quest/assets/neighborhood-scenes-v2.png`: 1672 × 941. Four quadrants:
  office, kitchen, creator studio and garden. Crops are drawn by the game at
  runtime. The generated output dimensions differ from the requested dimensions;
  the renderer uses the asset's actual dimensions.
