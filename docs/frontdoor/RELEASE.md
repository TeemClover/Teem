...
- Public path audit includes kitchen: 716 targets in the exact integration tree (X-VISOR held), zero unresolved references.
...
Merge review preserved remote shelf work and the existing published X-VISOR
runtime. Remote-only `xircle/experience-v2.js` and `.css` were removed explicitly
